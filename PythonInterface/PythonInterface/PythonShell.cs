...
namespace PythonInterface
{
    public partial class PythonShell : Form
    {
        ...
        private void Test_Click(object sender, EventArgs e)
        {
            ...
            System.IO.File.WriteAllText(@"C:\PythonInterface\" + name + ".py", PythonCanvas.Text);
            try
            {
                ...
                p.StartInfo.Arguments = @"C:\PythonInterface\" + name + ".py";
                p.Start();
            ...
            console.Text = output;
            System.IO.File.Delete(@"C:\PythonInterface\" + name + ".py");
        }
